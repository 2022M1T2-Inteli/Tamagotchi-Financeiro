...
onready var ground_obstacle: PackedScene = preload("res://Scenes/GroundObstacle.tscn")
onready var air_obstacle: PackedScene = preload("res://Scenes/AirObstacle.tscn")
